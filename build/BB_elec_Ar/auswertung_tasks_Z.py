...
file = r"C:\Users\tobys\Documents\GitHub\Geant4Box\build\BB_elec_Ar\BB_eloss.txt" # takes first argument as filename
...
plt.errorbar(energie, MPV, yerr=ERR, marker= 'x', markersize=6,
...
plt.xlabel(r"$\beta \gamma$",fontsize='16')
