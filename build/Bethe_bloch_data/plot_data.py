...
file2 = r'C:\Users\tobys\Documents\GitHub\Geant4Box\build\Bethe_bloch_data\bethe_b.txt' # takes first argument as filename
...
plt.errorbar(energie*5e-2, MPV*1e-4, yerr=ERR*1e-6, marker= 'x', markersize=10,
...
#plt.savefig(r'Bethe_B_Ar_low_beta.pdf')
#plt.clf()
#plt.close()
